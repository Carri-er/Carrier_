...
public interface IAiDAO {
	...
	public int save_course_insert(String id, String name, String thema,String area, String content, String distance,String day,String num,String img, int amount);
